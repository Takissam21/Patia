...
Compile(){
    ...
    mkdir -p classes
	javac -d classes -cp lib/pddl4j-4.0.0.jar:lib/org.sat4j.core.jar:lib/sat4j-sat.jar src/fr/uga/pddl4j/yasp/*.java
}
...
Solve(){
    ...
    java -cp classes:lib/pddl4j-4.0.0.jar:lib/org.sat4j.core.jar:lib/sat4j-sat.jar -server -Xms2048m -Xmx2048m fr.uga.pddl4j.yasp.YetAnotherSATPlanner $domainFile $problemFile
}
